...
* **Product families**: Support multiple product families
* **Rationale**: Abstract factory enables product families

### Implementation
* **Abstract factory**: Abstract factory interface
* **Concrete factories**: Concrete factory implementations
* **Product families**: Related product interfaces
* **Rationale**: Implementation enables product families
...
### Purpose
* **Clone objects**: Clone existing objects
* **Avoid creation cost**: Avoid expensive object creation
* **Flexibility**: Support dynamic object creation
* **Rationale**: Prototype enables efficient cloning

### Implementation
* **Clone method**: Virtual clone method
* **Copy constructor**: Use copy constructor or clone
* **Registry**: Optional prototype registry
* **Rationale**: Implementation enables cloning
